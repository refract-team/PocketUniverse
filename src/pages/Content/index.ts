...
const phishingRedirect = () => {
  ...
  // Update the location.
  window.location.href = `https://pocketuniverse.app/phishing/#${querystring}`;
};

// Skip pocketuniverse, since this is where we'll hosting the phishing url and don't want to infinitely repeat it.
if (window.location.hostname != 'www.pocketuniverse.app') {
  browser.runtime.sendMessage({
